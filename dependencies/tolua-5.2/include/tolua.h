...
TOLUA_API int tolua_isfunction(lua_State *L, int lo, int def,
                               tolua_Error *err);
TOLUA_API int tolua_isuserdata(lua_State *L, int lo, int def,
                               tolua_Error *err);
TOLUA_API int tolua_isusertype(lua_State *L, int lo, const char *type,
                               int def, tolua_Error *err);
...
TOLUA_API void tolua_cclass(lua_State *L, const char *lname,
...
TOLUA_API double tolua_tofieldnumber(lua_State *L, int lo, int index,
                                     double def);
