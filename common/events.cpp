...
static struct {
  ...
  enum event_type event;
    ...
    GEN_EV(E_MY_SPY_STEAL_SCIENCE, E_S_D_ME, N_("Science Theft")),
    GEN_EV(E_MY_SPY_STEAL_MATERIALS, E_S_D_ME, N_("Materials Theft")),
    ...
    GEN_EV(E_ENEMY_SPY_STEAL_SCIENCE, E_S_D_THEM, N_("Science Theft")),
    GEN_EV(E_ENEMY_SPY_STEAL_MATERIALS, E_S_D_THEM, N_("Materials Theft")),
    ...
    GEN_EV(E_SPONTANEOUS_EXTRA, E_S_XYZZY,
           N_("Extra Appears or Disappears")),
