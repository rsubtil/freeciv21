...
static void hard_code_actions()
{
  ...
  actions[ACTION_WIRETAP] = unit_action_new(
      ...
      ACT_TGT_COMPL_MANDATORY, true, true, MAK_TELEPORT, 0, 0, false);
  actions[ACTION_TRANSPORT_REPORT] = unit_action_new(
      ACTION_TRANSPORT_REPORT, ACTRES_TRANSPORT_REPORT, ATK_TILE, ASTK_EXTRA,
      ACT_TGT_COMPL_MANDATORY, true, true, MAK_TELEPORT, 0, 0, false);
  ...
  actions[ACTION_SABOTAGE_BUILDING] = unit_action_new(
      ACTION_SABOTAGE_BUILDING, ACTRES_SABOTAGE_BUILDING, ATK_TILE, ASTK_EXTRA,
      ACT_TGT_COMPL_MANDATORY, true, true, MAK_STAYS, 0, 0, false);
  actions[ACTION_SABOTAGE_TRANSPORT] = unit_action_new(
      ACTION_SABOTAGE_TRANSPORT, ACTRES_SABOTAGE_TRANSPORT, ATK_TILE, ASTK_EXTRA,
      ACT_TGT_COMPL_MANDATORY, true, true, MAK_STAYS, 0, 0, false);
  ...
  actions[ACTION_USER_ACTION3] =
      unit_action_new(ACTION_USER_ACTION3, ACTRES_NONE,
                      ...
                      // Overwritten by the ruleset
                      0, 1, false);
  actions[ACTION_SABOTAGE_CITY_INVESTIGATE_GOLD] = unit_action_new(
      ACTION_SABOTAGE_CITY_INVESTIGATE_GOLD, ACTRES_SABOTAGE_CITY_INVESTIGATE_GOLD,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_CITY_INVESTIGATE_SCIENCE] = unit_action_new(
      ACTION_SABOTAGE_CITY_INVESTIGATE_SCIENCE, ACTRES_SABOTAGE_CITY_INVESTIGATE_SCIENCE,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_CITY_INVESTIGATE_MATERIALS] = unit_action_new(
      ACTION_SABOTAGE_CITY_INVESTIGATE_MATERIALS, ACTRES_SABOTAGE_CITY_INVESTIGATE_MATERIALS,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_CITY_STEAL_GOLD] = unit_action_new(
      ACTION_SABOTAGE_CITY_STEAL_GOLD, ACTRES_SABOTAGE_CITY_STEAL_GOLD,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_CITY_STEAL_SCIENCE] = unit_action_new(
      ACTION_SABOTAGE_CITY_STEAL_SCIENCE, ACTRES_SABOTAGE_CITY_STEAL_SCIENCE,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_CITY_STEAL_MATERIALS] = unit_action_new(
      ACTION_SABOTAGE_CITY_STEAL_MATERIALS, ACTRES_SABOTAGE_CITY_STEAL_MATERIALS,
      ATK_CITY, ASTK_NONE, ACT_TGT_COMPL_SIMPLE, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_INVESTIGATE_GOLD] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_INVESTIGATE_GOLD, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_GOLD,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_STEAL_GOLD] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_STEAL_GOLD, ACTRES_SABOTAGE_BUILDING_STEAL_GOLD,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_STEAL_SCIENCE] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_STEAL_SCIENCE, ACTRES_SABOTAGE_BUILDING_STEAL_SCIENCE,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_SABOTAGE_BUILDING_STEAL_MATERIALS] = unit_action_new(
      ACTION_SABOTAGE_BUILDING_STEAL_MATERIALS, ACTRES_SABOTAGE_BUILDING_STEAL_MATERIALS,
      ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true, MAK_STAYS, 0, 1, false);
  actions[ACTION_TRANSPORT_REPORT] = unit_action_new(ACTION_TRANSPORT_REPORT,
      ACTRES_TRANSPORT_REPORT, ATK_TILE, ASTK_EXTRA, ACT_TGT_COMPL_MANDATORY, false, true,
      MAK_STAYS, 0, 1, false);
}
...
enum unit_activity action_get_activity(const struct action *paction)
{
  ...
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_INVESTIGATE_GOLD)) {
    return ACTIVITY_SABOTAGE_CITY_INVESTIGATE_GOLD;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_INVESTIGATE_SCIENCE)) {
    return ACTIVITY_SABOTAGE_CITY_INVESTIGATE_SCIENCE;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_INVESTIGATE_MATERIALS)) {
    return ACTIVITY_SABOTAGE_CITY_INVESTIGATE_MATERIALS;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_STEAL_GOLD)) {
    return ACTIVITY_SABOTAGE_CITY_STEAL_GOLD;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_STEAL_SCIENCE)) {
    return ACTIVITY_SABOTAGE_CITY_STEAL_SCIENCE;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_CITY_STEAL_MATERIALS)) {
    return ACTIVITY_SABOTAGE_CITY_STEAL_MATERIALS;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_GOLD)) {
    return ACTIVITY_SABOTAGE_BUILDING_INVESTIGATE_GOLD;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE)) {
    return ACTIVITY_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS)) {
    return ACTIVITY_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_STEAL_GOLD)) {
    return ACTIVITY_SABOTAGE_BUILDING_STEAL_GOLD;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_STEAL_SCIENCE)) {
    return ACTIVITY_SABOTAGE_BUILDING_STEAL_SCIENCE;
  } else if (action_has_result(paction, ACTRES_SABOTAGE_BUILDING_STEAL_MATERIALS)) {
    return ACTIVITY_SABOTAGE_BUILDING_STEAL_MATERIALS;
  } else if (action_has_result(paction, ACTRES_WIRETAP)) {
    return ACTIVITY_WIRETAP;
  } else if (action_has_result(paction, ACTRES_TRANSPORT_REPORT)) {
    return ACTIVITY_TRANSPORT_REPORT;
  } else {
...
const char *action_ui_name_ruleset_var_name(int act)
{
  ...
  case ACTION_TRANSPORT_REPORT:
    return "ui_name_transport_report";
  case ACTION_SABOTAGE_CITY:
    return "ui_name_sabotage_city";
  case ACTION_SABOTAGE_BUILDING:
    return "ui_name_sabotage_building";
  case ACTION_SABOTAGE_TRANSPORT:
    return "ui_name_sabotage_transport";
  ...
  case ACTION_SABOTAGE_BUILDING_INVESTIGATE_GOLD:
    return "ui_name_sabotage_building_investigate_gold";
  case ACTION_SABOTAGE_BUILDING_INVESTIGATE_SCIENCE:
    return "ui_name_sabotage_building_investigate_science";
  case ACTION_SABOTAGE_BUILDING_INVESTIGATE_MATERIALS:
    return "ui_name_sabotage_building_investigate_materials";
  case ACTION_SABOTAGE_BUILDING_STEAL_GOLD:
    return "ui_name_sabotage_building_steal_gold";
  case ACTION_SABOTAGE_BUILDING_STEAL_SCIENCE:
    return "ui_name_sabotage_building_steal_science";
  case ACTION_SABOTAGE_BUILDING_STEAL_MATERIALS:
    return "ui_name_sabotage_building_steal_materials";
  case ACTION_COUNT:
    break;
  }
