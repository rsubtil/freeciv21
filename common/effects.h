...
#define SPECENUM_VALUE146 EFT_PUBLIC_UNITS_MOVE_RATE
#define SPECENUM_VALUE146NAME "Public_Units_Move_Rate_Pct"
#define SPECENUM_VALUE147 EFT_BASE_PRODUCTION_RATE
#define SPECENUM_VALUE147NAME "Base_Production_Rate_Pct"
